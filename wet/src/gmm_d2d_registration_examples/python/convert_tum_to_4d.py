...
Usage:
    python convert_tum_to_4d.py --bag ~/thesis/mai_city/bags/rgbd_dataset_freiburg3_long_office_household.bag
    python convert_tum_to_4d.py --bag ~/thesis/mai_city/bags/rgbd_dataset_freiburg3_long_office_household.bag --start-id 100 --final-id 500
"""
import os
import sys
import argparse
